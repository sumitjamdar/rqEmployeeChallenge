...
class EmployeeControllerTest {
    ...
    void testGetEmployeeById_found() {
        when(employeeService.getEmployeeById("1")).thenReturn(Optional.of(makeEmployee("1", "John", 1000)));
    ...
    void testGetEmployeeById_notFound() {
        ...
        ResponseEntity<EmployeeDto> response = controller.getEmployeeById("2");
    ...
    void testGetTopTenHighestEarningEmployeeNames() {
        when(employeeService.getTopTenHighestEarningEmployeeNames()).thenReturn(List.of("John", "Jane"));

        ResponseEntity<List<String>> response = controller.getTopTenHighestEarningEmployeeNames();

        assertEquals(200,response.getStatusCode().value());
        assertEquals(List.of("John", "Jane"), response.getBody());
    ...
    void testDeleteEmployeeById_success() {
        ...
        ResponseEntity<String> response = controller.deleteEmployeeById("John");
